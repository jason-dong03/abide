...
CREATE UNIQUE INDEX uq_login_events_user_day
  ON login_events (user_id, date_trunc('day', logged_in_at));
...
CREATE TABLE IF NOT EXISTS challenge_participants(
    ...
    challenge_id NOT NULL REFERENCES challenges(challenge_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS checkins (
    ...
    participant_id NOT NULL REFERENCES challenge_participants(participant_id) ON DELETE CASCADE,
