...
<html>
    ...
    <body>
        ...
        <div id="main" class="outer-container">
            <div class="blur-container d-flex flex-column align-items-center justify-content-center text-center p-5">
            ...
            <a id="register-btn" role="button" tabindex="0"
                class="btn-container register p-2 w-50 mx-auto mt-3">Register</a>

            <a id="login-btn" role="button" tabindex="0"
                class="btn-container p-2 w-50 mx-auto">Login</a>
            </div>
        </div>
        ...
        <div class="outer-container">
            <div class="alert alert-danger text-center w-50 mx-auto mt-3 mb-0">
            <?= h($error) ?>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div id="register" class="d-none outer-container">
            <div class="blur-container p-4 d-flex flex-column h-100 w-75">
              ...
              <!-- POSTS to index.php?action=start -->
              <form class="auth-form d-flex flex-column text-start gap-3" method="post"
                      action="index.php?action=start" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" novalidate>
                ...
                <div class="reg-top">
                  <div class="avatar-column">
                      ...
                      <img id="avatar-icon" src="../assets/icons/profile.svg" alt="Upload">
                      </div>
                  ...
                  <div class="row g-2">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="email" id="reg-email" name="email" placeholder="you@example.com" value="<?= h($email) ?>" required>
                    </div>
                    <div class="col-12 col-md-6">
                  ...
                  <div class="row g-2 mb-1">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="password" id="reg-pwd" name="password" placeholder="Create a password" required minlength="5" autocomplete="new-password">
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="reg-pwd-repeat">Repeat Password</label>
                        <input type="password" id="reg-pwd-repeat" placeholder="Repeat password" required>
                    </div>
                  </div>
                  ...
                  <div class="auth-actions d-flex flex-column w-50 mx-auto gap-3 mt-3">
                    ...
                    <button type="button" id="back-btn-reg" class=" btn-secondary-glass">Back</button>
                  </div>
              </form>
            </div>
        </div>
          ...
          <div class="blur-container p-4 d-flex flex-column h-100 w-50">
            ...
            <form class="auth-form d-flex flex-column text-start gap-3" method="post"
              ...
              <div>
                ...
                <input type="email" id="login-email" name="email" placeholder="you@example.com" value="<?= h($email) ?>" required autocomplete="email">
              </div>

              <div>
                <label for="login-pwd">Password</label>
                <input type="password" id="login-pwd" name="password" placeholder="password" required minlength="5" autocomplete="current-password">
              </div>

              <div class="auth-actions d-flex flex-column w-50 mx-auto gap-3 mt-3">
                <button type="submit" class="btn-primary-glass">Login</button>
                <button type="button" id="back-btn-login" class="btn-secondary-glass">Back</button>
                <p class="small text-center mt-2 mb-0">Forgot password? click <a href="index.php?action=forgot">here</a></p>
              </div>
            </form>
          </div>
        </div>
        ...
        <script>
            ...
            hide("main"); show("register"); hide("login");
            setTimeout(() => document.getElementById('first-name')?.focus(), 0);
            };
            document.getElementById("login-btn").onclick = () => {
            hide("main"); hide("register"); show("login");
            ...
            const pwd2  = document.getElementById('reg-pwd-repeat')?.value || '';
            if (pwd !== pwd2) {
                e.preventDefault();
